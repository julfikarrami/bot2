...
const client = new Client({
    authStrategy: new LocalAuth(),  // ← session save
    puppeteer: {
...
client.on("qr", qr => {
    console.clear();
    console.log("Scan QR with your WhatsApp (Linked Devices → Link a Device):");
